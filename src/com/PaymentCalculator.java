...
public class PaymentCalculator {
    ...
    private int[] getSalaries(){  //Gets last years salary + the sum of previous salaries
    ...
    private int getSalaryInt(int tYear){ //Gets salaries from user and makes sure its an int
    ...
    //Add verbose?
    public boolean isInteger( String inp ) { //Checks if int..
        try {
    ...
    public int calculatePayment(int lSalary, int sSalary, boolean verbose){  //Calculates daily payment
